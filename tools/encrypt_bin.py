...
def encrypt_bin_file(bin_file_path, key_file_path, output_file_path, verbose=False):
...
if __name__ == "__main__":
    ...
    encrypt_bin_file(args.bin_file, args.key_file, args.output_file, args.verbose)